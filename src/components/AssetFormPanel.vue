      ...
      <div v-if="visible" class="form-overlay" @click.self="$emit('cancel')">
        <div class="form-sheet">
          ...
          <div class="form-body">
            ...
            <div class="form-section">
              <label class="form-label">我的资产</label>
              <input
                v-model="amount"
                type="number"
                class="form-input"
...
.form-time-arrow { position: absolute; right: 16px; color: #bbb; flex-shrink: 0; }
...
.picker-card { width: 340px; background: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 8px 32px rgba(0, 0, 0, 0.12); }
...
.picker-close:hover { background: #e0e0e0; }
...
.picker-arrow { width: 100%; height: 30px; border: none; background: #f5f5f5; border-radius: 8px; color: #888; font-size: 11px; cursor: pointer; display: flex; align-items: center; justify-content: center; transition: background 0.12s; }
.picker-arrow:hover { background: #e8e8e8; }
.picker-arrow:active { background: #ddd; }
.picker-value { font-size: 34px; font-weight: 700; color: #1a1a1a; line-height: 1.2; text-align: center; font-variant-numeric: tabular-nums; }
.picker-value-sm { font-size: 28px; }
.picker-unit { font-size: 11px; color: #999; margin-top: -2px; }
.picker-confirm { display: block; width: auto; margin: 0 auto 16px; padding: 8px 36px; border: none; background: #2c2c2c; color: #ffffff; font-size: 14px; font-weight: 500; border-radius: 10px; cursor: pointer; transition: background 0.15s; }
.picker-confirm:hover { background: #444; }
.picker-confirm:active { background: #1a1a1a; }
