      ...
      <div v-if="visible" class="form-overlay" @click.self="$emit('cancel')">
        <div class="form-sheet">
          <div class="form-navbar">
            ...
            <span class="form-nav-title">{{ kind === 'positive' ? '念头·正' : '念头·负' }}</span>
...
.picker-enter-active .picker-card,
.picker-leave-active .picker-card {
...
.form-enter-active .form-sheet,
.form-leave-active .form-sheet {
...
.form-enter-from .form-sheet,
.form-leave-to .form-sheet {
